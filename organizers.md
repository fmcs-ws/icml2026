...
<div style="display: flex; flex-wrap: wrap; gap: 2rem;">
  <div class="organizer-card" style="flex: 1 1 300px; text-align: center;">
    <img src="{{ site.baseurl }}/assets/images/organizers/stephen-baek.jpg" alt="Stephen Baek" style="width:150px; border-radius:50%;">
    <h3>Stephen Baek</h3>
    <p>University of Virginia</p>
  </div>
  <div class="organizer-card" style="flex: 1 1 300px; text-align: center;">
    <img src="{{ site.baseurl }}/assets/images/organizers/johannes-brandstetter.jpg" alt="Johannes Brandstetter" style="width:150px; border-radius:50%;">
