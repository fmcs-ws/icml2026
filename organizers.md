...
<div class="cards-container">
  ...
  <div class="card">
    <img src="{{ site.baseurl }}/assets/images/organizers/stephen-baek.jpg" alt="Stephen Baek" class="card-photo">
    <h3 class="card-name">Stephen Baek</h3>
    <p class="card-affiliation">University of Virginia</p>
    <p class="card-bio">Stephen Baek is an Associate Professor at the University of Virginia School of Data Science. His research lies at the intersection of applied geometry and machine learning, with an emphasis on geometric data analysis and shape/geometry representations. He has contributed service and community-building activities, including roles such as program board membership and organizing committee service for recurring conferences in computational design/CAD-related communities.</p>
    <div class="card-socials">
      <a href="https://www.stephenbaek.com" target="_blank">Webpage</a>
  ...
  <div class="card">
    ...
    <h3 class="card-name">Johannes Brandstetter</h3>
    <p class="card-affiliation">Johannes Kepler University</p>
    <p class="card-bio">Johannes Brandstetter is Co-Founder and Chief Scientist at Emmi AI and an Associate Professor at JKU Linz. He works at the intersection of geometric deep learning and scientific machine learning, with contributions spanning weather modeling, generative modeling, and large-scale PDE surrogates. He is active in the broader ML community through invited presentations at scientific ML workshops and related venues.</p>
    <div class="card-socials">
      <a href="https://brandstetter-johannes.github.io/" target="_blank">Webpage</a>
      <a href="https://scholar.google.com/citations?user=KiRvOHcAAAAJ&hl=en&oi=ao" target="_blank">Google Scholar</a>
    </div>
  </div>
